...
test("builds a safe offer update URL", () => {
  const url = buildTakealotUrl(
    "https://marketplace-api.takealot.com/v1",
    "offers",
    new URLSearchParams(),
  ...
  assert.equal(url.toString(), "https://marketplace-api.takealot.com/v1/offers/231949041");
  assert.throws(
    () => buildTakealotUrl("https://marketplace-api.takealot.com/v1", "offers", new URLSearchParams(), "../seller"),
    /Invalid/,
  );
});
